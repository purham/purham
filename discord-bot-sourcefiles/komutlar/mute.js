...
let mutex = new Discord.RichEmbed()
.setColor("#00ff00")
.setTitle("Mute Komutu")
.addField("Açıklama:", `Susturucu`, true)
.addField("Kullanımı:", "r!mute [user] [vakit] [sebeb]", true)
.addField("Test:" ,"r!mute @vevampire <vakit> <neden>")

  let member = message.mentions.members.first();
  if(!member) return message.channel.send(mutex)
